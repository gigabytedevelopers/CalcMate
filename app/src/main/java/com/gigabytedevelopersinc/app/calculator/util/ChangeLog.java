...
public class ChangeLog {
    ...
    public static final String DEFAULT_CSS =
            "h1 { margin-left: 15px; margin-top: 15px; margin-bottom: -5px; font-size: 1.15em; }" + "\n" +
            "h2 { margin-left: 15px; margin-top: 5px; margin-bottom: -5px; font-size: 0.9em; font-weight: normal; font-style: italic; }" + "\n" +
            "li { margin-left: 0px; }" + "\n" +
            "ul { padding-left: 2em; }";
    ...
    protected AlertDialog getDialog(boolean full) {
        ...
        title.setText(Html.fromHtml("<b>" + mContext.getResources().getString(
                full ? R.string.changelog_full_title : R.string.changelog_title, Html.fromHtml("</b>"))));
        title.setPadding(50, 20, 30, 20);
        title.setTextSize(23);
        title.setGravity(Gravity.START);
        title.setTextColor(ContextCompat.getColor(mContext, R.color.maindigitbacks));
    ...
    protected String getLog(boolean full) {
        ...
        String versionFormat = mContext.getResources().getString(R.string.changelog_version_format) + " " + mCurrentVersionName;

        List<ReleaseItem> changelog = getChangeLog(full);

        for (ReleaseItem release : changelog) {
            sb.append("<h1>");
            sb.append(String.format(versionFormat, mCurrentVersionName));
            sb.append("</h1><h2>");
    ...
    private boolean parseReleaseTag(XmlPullParser xml, boolean full,
        ...
        String date = xml.getAttributeValue(null, ReleaseTag.ATTRIBUTE_DATE);
        ...
        ReleaseItem release = new ReleaseItem(versionCode, version, date, changes);
    ...
    public static class ReleaseItem {
        ...
        ReleaseItem(int versionCode, String versionName, String date, List<String> changes) {
