...
public class CalculatorWidget extends AppWidgetProvider {
    public final static String PREFERENCE_WIDGET_PREAMBLE = "com.gigabytedevelopersinc.app.calculator.CALC_WIDGET_VALUE_";
    public static final String DIGIT_0 = "com.gigabytedevelopersinc.app.calculator.0";
    public static final String DIGIT_1 = "com.gigabytedevelopersinc.app.calculator.1";
    public static final String DIGIT_2 = "com.gigabytedevelopersinc.app.calculator.2";
    public static final String DIGIT_3 = "com.gigabytedevelopersinc.app.calculator.3";
    public static final String DIGIT_4 = "com.gigabytedevelopersinc.app.calculator.4";
    public static final String DIGIT_5 = "com.gigabytedevelopersinc.app.calculator.5";
    public static final String DIGIT_6 = "com.gigabytedevelopersinc.app.calculator.6";
    public static final String DIGIT_7 = "com.gigabytedevelopersinc.app.calculator.7";
    public static final String DIGIT_8 = "com.gigabytedevelopersinc.app.calculator.8";
    public static final String DIGIT_9 = "com.gigabytedevelopersinc.app.calculator.9";
    public static final String DOT = "com.gigabytedevelopersinc.app.calculator.dot";
    public static final String PLUS = "com.gigabytedevelopersinc.app.calculator.plus";
    public static final String MINUS = "com.gigabytedevelopersinc.app.calculator.minus";
    public static final String MUL = "com.gigabytedevelopersinc.app.calculator.mul";
    public static final String DIV = "com.gigabytedevelopersinc.app.calculator.div";
    public static final String EQUALS = "com.gigabytedevelopersinc.app.calculator.equals";
    public static final String CLEAR = "com.gigabytedevelopersinc.app.calculator.clear";
    public static final String DEL = "com.gigabytedevelopersinc.app.calculator.delete";
    ...
    private static void setOnClickListeners(Context context, int appWidgetId, RemoteViews remoteViews) {
        ...
        remoteViews.setOnClickPendingIntent(R.id.digit0, PendingIntent.getBroadcast(context, shiftedAppWidgetId, intent, 0));
    ...
    private static void setValue(Context context, int appWidgetId, String newValue) {
        PreferenceManager.getDefaultSharedPreferences(context).edit().putString(PREFERENCE_WIDGET_PREAMBLE + appWidgetId, newValue).apply();
    }
}
